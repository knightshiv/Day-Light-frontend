...
function Sidenav({ color }) {
      ...
      <Menu.Item key="2">
        <NavLink to="/ListStaffs">
          <span
            className="icon"
            style={{
              background: page === "ListStaffs" ? '#1B3D3B' :color,
            }}
          >
            {profile}
          </span>
      ...
      <Menu.Item key="3">
        <NavLink to="/staffleaves">
          <span
            className="icon"
            style={{
              background: page === "staffleaves" ? '#1B3D3B' :color,
            }}
          >
            {rtl}
          </span>
      ...
      <Menu.Item key="5">
        <NavLink to="/staffsetup">
          <span
            className="icon"
            style={{
              background: page === "staffsetup" ? "#1B3D3B": color,
            }}
          >
            {billing}
          </span>
      ...
      <Menu.Item key="6">
        <NavLink to="/departmentsetup">
          <span
            className="icon"
            style={{
              background: page === "departmentsetup" ? '#1B3D3B' :color,
            }}
          >
            {billing}
          </span>
  ...
  <span
    className="icon"
    style={{
      background: page === "SalarySetup" ? '#1B3D3B' : color,
    }}
  >
    {tables}
  </span>
  <span className="label">Salary Setup</span>
      ...
      <Menu.Item key="8">
        <a href="https://daylightmanagement.in/contact.html" target="_blank" rel="noopener noreferrer">
